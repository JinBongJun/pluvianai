...
This README mirrors the plan from `docs/demo/demo-support-bot-a1-plan.md`, translated
...
- `docs/demo/demo-support-bot-a1-plan.md`
- `docs/demo/content-and-demo-execution-plan.md`
