...
| 프론트엔드 | [frontend-refactoring-implementation-plan.md](./frontend-refactoring-implementation-plan.md) (**진행 중**), [live-view-rg-polling-inventory.md](./live-view-rg-polling-inventory.md), [frontend-api-split-design.md](./frontend-api-split-design.md), [UI_GUIDE.md](./UI_GUIDE.md) |
| 실시간 파이프라인·운영 | [mvp-realtime-pipeline-implementation-plan.md](./mvp-realtime-pipeline-implementation-plan.md), [ops-ingest-observability.md](./ops-ingest-observability.md), [mvp-ops-alerting-minimum-plan.md](./mvp-ops-alerting-minimum-plan.md), [mvp-ops-slack-alerts-implementation-plan.md](./mvp-ops-slack-alerts-implementation-plan.md), [load-test-capacity-baseline-2026-03.md](./load-test-capacity-baseline-2026-03.md) |
| Behavior API | [BEHAVIOR_RULE_API_CONTRACT.md](./BEHAVIOR_RULE_API_CONTRACT.md) |
| 요금·크레딧 | [mvp-usage-credits-and-pricing-plan.md](./mvp-usage-credits-and-pricing-plan.md), [mvp-usage-credits-implementation-checklist.md](./mvp-usage-credits-implementation-checklist.md), [mvp-free-tier-limits-implementation-plan.md](./mvp-free-tier-limits-implementation-plan.md), [billing-hardening-runbook.md](./billing-hardening-runbook.md), [billing-prometheus-grafana-alerts.md](./billing-prometheus-grafana-alerts.md) |
