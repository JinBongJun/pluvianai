...
- **🚀 빠른 시작**: [QUICK_START.md](./docs/QUICK_START.md) - 5분 안에 시작하기
- **⭐ 프로덕션 우선**: [PRODUCTION_FIRST_GUIDE.md](./docs/PRODUCTION_FIRST_GUIDE.md) - 프로덕션 중심 개발 가이드
- **📊 모니터링**: [PRODUCTION_MONITORING.md](./docs/PRODUCTION_MONITORING.md) - Vercel + Railway 모니터링
- **🔄 배포**: [DEPLOYMENT_WORKFLOW.md](./docs/DEPLOYMENT_WORKFLOW.md) - 자동 배포 워크플로우
...
- **프론트엔드**: Vercel 대시보드에서 확인
- **백엔드**: Railway 대시보드에서 확인

**자세한 가이드**: [프로덕션 우선 개발 가이드](./docs/PRODUCTION_FIRST_GUIDE.md)
