      ...
      <div className="bg-[#000314] min-h-screen">
        ...
        <div className="mb-6 flex items-center gap-4">
          ...
          <div className="relative">
            <button className="flex items-center justify-between gap-2 px-3 py-2 border border-white/10 bg-white/5 rounded-md text-sm text-white hover:bg-white/10 transition-colors min-w-[120px]">
