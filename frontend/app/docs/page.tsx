          ...
          <div className="rounded-[32px] border border-white/10 bg-white/[0.02] p-8 max-w-5xl space-y-8 relative overflow-hidden backdrop-blur-md">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xs text-slate-500 leading-relaxed max-w-3xl mt-4">
                ...
                / ?úTool Result Grounding?? that are computed during compare/replay ??they are not
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="rounded-xl border border-white/10 bg-black/20 p-4">
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Use for org-wide safety: block dangerous tools, enforce ?úsearch before answer??
              ...
              <div className="rounded-xl border border-white/10 bg-black/20 p-4">
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Use when one agent has special permissions (e.g., ?úpayments_agent??can call
              ...
              <div className="rounded-xl border border-white/10 bg-black/20 p-4 md:col-span-2">
                <h5 className="text-sm font-black text-white">4) What is a ?úTool??</h5>
                <p className="mt-2 text-xs text-slate-400">
                ...
                <p className="mt-3 text-xs text-slate-500">
                  ...
                  for ?úmust be correct??tools (payments, secrets, outbound side-effects).
                </p>
              </div>
            </div>
            <div className="rounded-xl border border-white/10 bg-black/20 p-4">
              ...
              <ul className="mt-2 text-xs text-slate-500 space-y-1 list-disc list-inside">
                ...
                <li>
                  <span className="text-slate-300 font-semibold">tool_order</span>: enforce ?úA must
                  happen before B??
                </li>
                <li>
      ...
      content: (
        <div className="space-y-8">
          <p className="text-xl text-slate-400 leading-relaxed max-w-4xl">
            ...
            an agent in Live View (older docs may say ?úLogic Guard??. Define rule-based policies on
