...
export default function QualityPage() {
  ...
  return (
    <ProjectLayout orgId={orgId} projectId={projectId} breadcrumb={[{ label: "Quality" }]}>
        ...
        <div className="mt-8 space-y-6">
          ...
          <div>
            ...
            <p className="text-slate-400">
              Monitor and analyze the quality of your AI responses over time
            </p>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="text-sm text-slate-400 space-y-2">
              ...
              <p className="mt-4">
                Higher scores indicate better overall performance. Aim for scores above 7.0 for
