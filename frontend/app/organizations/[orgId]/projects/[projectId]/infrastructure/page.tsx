        ...
        >
            <div className="max-w-6xl mx-auto space-y-12 pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        <div className={`absolute top-0 right-0 p-4 ${sentinelStatus?.sentinel_online ? 'text-emerald-500' : 'text-slate-600'}`}>
                            <div className={clsx(
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 text-slate-400">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest">Sentinel Status</span>
                            </div>
                    ...
                    >
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 text-slate-400">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest">Mapping Accuracy</span>
                            </div>
                    ...
                    >
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 text-sky-400">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest">Latency Optimization</span>
                            </div>
                            <h3 className="text-2xl font-bold text-white uppercase italic">
                                REAL-TIME
                            </h3>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="p-8 rounded-[40px] bg-[#1a1a1c] border border-white/5 space-y-6">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-sm font-black">1</div>
                                ...
                                >
                                    {copiedSection === 'docker' ? <Check className="w-4 h-4 text-emerald-500" /> : <Copy className="w-4 h-4" />}
                                </button>
                            </div>
                            <p className="text-sm text-slate-400 italic">
                                Spin up a local security collector to intercept and analyze neural traffic with ZERO data leaks.
                            </p>
                        ...
                        <div className="p-8 rounded-[40px] bg-[#1a1a1c] border border-white/5 space-y-6">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-sm font-black">2</div>
                                ...
                                <button
                                    ...
                                    className="p-2 rounded-lg bg-white/5 hover:bg-white/10 text-slate-400 transition-all"
                                >
                                    {copiedSection === 'sdk' ? <Check className="w-4 h-4 text-emerald-500" /> : <Copy className="w-4 h-4" />}
                                </button>
                            </div>
                            <p className="text-sm text-slate-400 italic">
                                Enable deterministic self-reporting within your agent code to synchronize architecture in real-time.
                            </p>
                            <div className="relative group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            <h2 className="text-3xl font-black text-white italic tracking-tighter uppercase leading-none">
                                Why switch to <br /> <span className="text-sky-500 italic uppercase italic uppercase italic uppercase italic lowercase">Deterministic</span> Mapping?
                            </h2>
                            <div className="space-y-4">
                                {[
                                    { title: "Zero Guesswork", desc: "Agents explicitly declare their position in the neural chain." },
                                    { title: "Local Privacy", desc: "Sensitive payload analysis stays within your firewall." },
                                    { title: "Deep Traceability", desc: "Track tokens and latency with microsecond precision." }
                                ].map((item, i) => (
                                    ...
                                    <div className="flex flex-col items-center gap-8 z-10">
                                        <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-3">
                                            ...
                                            <div className="text-left">
                                                <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Neural Agent</div>
                                                <div className="text-sm font-bold text-white tracking-tight">Agent_Alpha_v2</div>
                                            </div>
                                        </div>
                                        <motion.div
                                        ...
                                        <div className="p-4 rounded-2xl bg-sky-500/10 border border-sky-400/30 flex items-center gap-3">
                                            ...
                                            <div className="text-left">
                                                <div className="text-[10px] font-bold text-sky-500 uppercase tracking-widest">SENTINEL NODE</div>
                                                <div className="text-sm font-bold text-white tracking-tight">Active_Mapping</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
