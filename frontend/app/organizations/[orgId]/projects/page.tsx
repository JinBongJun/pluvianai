...
import { Search, Building2, LayoutGrid, List, Plus, Filter, Info, AlertTriangle, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <p className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.3em]">Authorized Laboratory Operations</p>
          </div>
          <h1 className="text-5xl font-black mb-10 text-white uppercase tracking-tighter">Clinical Trials</h1>
              ...
              <div className="flex items-center gap-1 p-1 rounded-2xl border border-white/5 bg-white/[0.03] backdrop-blur-3xl">
                <button
                  ...
                  className={clsx(
                    ...
                    view === 'grid' ? 'bg-emerald-500 text-black shadow-[0_0_20px_rgba(16,185,129,0.3)]' : 'text-slate-500 hover:text-white hover:bg-white/5'
                  )}
                >
                ...
                <button
                  ...
                  className={clsx(
                    'p-3 rounded-xl transition-all',
                    view === 'list' ? 'bg-emerald-500 text-black shadow-[0_0_20px_rgba(16,185,129,0.3)]' : 'text-slate-500 hover:text-white hover:bg-white/5'
                  )}
                >
                    ...
                    <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="none" viewBox="0 0 1000 100">
                      ...
                      <path
                        ...
                        style={{
                          ...
                          animation: 'ecg-trace 4s linear infinite, medical-pulse 2s ease-in-out infinite'
                        }}
                      />
                    </svg>
                  </div>
