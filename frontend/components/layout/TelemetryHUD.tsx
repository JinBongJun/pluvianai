      ...
      {stats.map((stat, i) => (
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] leading-none mb-2">
              {stat.label}
            </span>
            <div className="flex items-baseline gap-2.5">
              <span className="text-xl font-black text-white leading-none tracking-tighter tabular-nums">
                {stat.value}
              </span>
          ...
          {/* Visual Separator */}
          {i < stats.length - 1 && <div className="ml-16 w-[1px] h-6 bg-white/10" />}
        </motion.div>
      ))}
