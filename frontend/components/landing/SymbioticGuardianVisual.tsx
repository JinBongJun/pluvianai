...
export default function SymbioticGuardianVisual() {
    return (
        <div className="relative w-full max-w-4xl mx-auto h-[400px] md:h-[500px] flex items-center justify-center opacity-90 pointer-events-none select-none">
            ...
            <svg viewBox="0 0 800 500" className="w-full h-full drop-shadow-[0_0_15px_rgba(16,185,129,0.1)]">
                <motion.path
            ...
            >
                ...
                {/* Bird Icon SVG */}
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-cyan-300 drop-shadow-[0_0_10px_rgba(6,182,212,0.8)] filter">
                    <path d="M16 7h.01" />
