              ...
              <div className="space-y-4">
                      ...
                      <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-3 py-2.5 text-sm font-semibold text-white/80 marker:content-none">
                        <span>
                          ...
                          <span className="text-[11px] font-semibold text-white/40">
                            {latestResultCard.visibleResultCases.length}
                          </span>
                        </span>
                        <span className="text-[11px] text-white/35 group-open:hidden">Expand</span>
                        <span className="hidden text-[11px] text-white/35 group-open:inline">
                          Collapse
                        </span>
                      </summary>
                          ...
                          <div className="rounded-2xl border border-dashed border-white/[0.08] bg-white/[0.02] px-3 py-4 text-sm text-white/30">
                            {resultCaseFilter === "failed"
                              ...
                              : resultCaseFilter === "passed"
                                ...
                                : "No per-input rows returned for this run."}
                          </div>
                        ) : (
                ...
                {earlierResultCards.length > 0 ? (
                  <button
                    ...
                    className="w-full rounded-2xl bg-black/20 px-3 py-2.5 text-left text-[11px] font-semibold text-white/70 ring-1 ring-white/[0.05] transition hover:bg-white/[0.03] hover:text-white"
                    title="Open History to see earlier results"
                  >
                    Earlier results are in History ({earlierResultCards.length})
                  </button>
                ) : null}
              </div>
            )}
