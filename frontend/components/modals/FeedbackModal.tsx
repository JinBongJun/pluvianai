                        ...
                        <div className="p-12">
                            <div className="flex items-center justify-between mb-10">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        <h2 className="text-3xl font-black text-white uppercase tracking-tighter">Share your feedback</h2>
                                        <p className="text-slate-500 text-sm font-bold uppercase tracking-widest mt-1">Help us evolve the symbiosis</p>
                                    </div>
                                </div>
                                <button
                                    onClick={onClose}
