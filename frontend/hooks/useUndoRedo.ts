...
export const useUndoRedo = (
  ...
  const undo = useCallback(
    (currentNodes: Node[], currentEdges: Edge[], currentSelectedNodeId: string | null) => {
      setPast(oldPast => {
        ...
        if (previousState) {
          ...
          setFuture(oldFuture => [
            { nodes: currentNodes, edges: currentEdges, selectedNodeId: currentSelectedNodeId },
            ...oldFuture,
          ]);
  ...
  ); // Dependencies: setters remain stable
