...
def upgrade():
    ...
    op.create_index('idx_refresh_token_user_expires', 'refresh_tokens', ['user_id', 'expires_at'], unique=False)
...
def downgrade():
    ...
    op.drop_index('idx_refresh_token_user_expires', table_name='refresh_tokens')
