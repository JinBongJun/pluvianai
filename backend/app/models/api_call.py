...
class APICall(Base):
    ...
    primary_shadow_comparisons = relationship("ShadowComparison", foreign_keys="ShadowComparison.primary_api_call_id", back_populates="primary_api_call", cascade="all, delete-orphan")
    shadow_shadow_comparisons = relationship("ShadowComparison", foreign_keys="ShadowComparison.shadow_api_call_id", back_populates="shadow_api_call", cascade="all, delete-orphan")
