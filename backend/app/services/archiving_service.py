...
class ArchivingService:
    ...
    def archive_old_data(self, project_id: Optional[int] = None) -> dict:
        ...
        try:
            ...
            if project_id:
                quality_filters = [QualityScore.created_at < cutoff_date, QualityScore.project_id == project_id]
            else:
            ...
            if project_id:
                drift_filters = [DriftDetection.detected_at < cutoff_date, DriftDetection.project_id == project_id]
            else:
