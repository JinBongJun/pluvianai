...
class QualityEvaluator:
    ...
    def evaluate(
        ...
        required_fields_present = (
            self._check_required_fields(response_data, required_fields) if required_fields else None
        )
        ...
        evaluation_details["score_breakdown"] = {
            ...
            "semantic_similarity": {
                ...
                "contribution": (
                    (llm_scores.get("semantic_consistency", 0) * self.LLM_WEIGHTS.get("semantic_consistency", 0) * 0.4)
                    if llm_scores
                    else 0
                ),
            },
            ...
            "consistency_over_time": {
                ...
                "contribution": (
                    (llm_scores.get("coherence", 0) * self.LLM_WEIGHTS.get("coherence", 0) * 0.4) if llm_scores else 0
                ),
            },
        }
    ...
    def _check_json_validity(self, response_data: Dict[str, Any], response_text: str) -> Optional[bool]:
    ...
    def _check_required_fields(self, response_data: Dict[str, Any], required_fields: List[str]) -> Optional[bool]:
    ...
    def _check_format(self, response_data: Dict[str, Any], response_text: str) -> Optional[bool]:
